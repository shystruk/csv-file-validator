...
document.getElementById("file").onchange = function (event) {
    csv_file_validator_1.default(event.target.files[0], CSVConfig).then((csvData) => {
        csvData.inValidMessages.forEach((message) => {
            var _a;
            (_a = document
                .getElementById("invalidMessages")) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML("beforeend", message.message);
        });
...
(function (global, factory) {
	 true
		? (module.exports = factory(
			...
			__webpack_require__(/*! famulus/isValuesUnique */ "../node_modules/famulus/isValuesUnique.js")
		))
		: 0;
